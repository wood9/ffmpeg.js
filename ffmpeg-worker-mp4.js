...
var Xa;
Xa || (Xa = typeof Module !== 'undefined' ? Module : {});
function Ya(H) {
  function ba(a, b, c, e) {
    a || (a = this);
    this.parent = a;
  ...
  function G(a) {
    ...
    return function(c, e) {
      ...
      10 === c || 13 === c ? (U && b.push(c), a(R(b, 0)), b = []) : 0 !== c && b.push(c);
    };
  }
  function wb(a) {
    return f.locateFile ? f.locateFile(a, N) : N + a;
  }
  function ta(a, b) {
  ...
  function Ma() {
    X--;
    f.monitorRunDependencies && f.monitorRunDependencies(X);
    if (0 == X && (null !== Na && (clearInterval(Na), Na = null), ja)) {
      var a = ja;
      ja = null;
      a();
    }
  ...
  function cb(a) {
    return Pa(a, "data:application/octet-stream;base64,");
  }
  function db() {
    try {
      if (ka) {
  ...
  function xb() {
    return ka || !va && !Q || "function" !== typeof fetch || Pa(O, "file://") ? new Promise(function(a) {
      a(db());
  ...
  function wa() {
    void 0 === wa.start && (wa.start = Date.now());
    return 1E3 * (Date.now() - wa.start) | 0;
  }
  function la() {
    if (!la.u) {
  ...
  function ya() {
    ...
    if (!ya.u) {
      ya.u = !0;
      m[hb() >> 2] = 60 * (new Date).getTimezoneOffset();
      var b = (new Date).getFullYear(), c = new Date(b, 0, 1);
      b = new Date(b, 6, 1);
      m[ib() >> 2] = Number(c.getTimezoneOffset() != b.getTimezoneOffset());
      var e = a(c), g = a(b);
      e = $a(e);
      g = $a(g);
  ...
  function Aa(a, b) {
    for (a = new Date(a.getTime()); 0 < b;) {
      var c = za(a.getFullYear()), e = a.getMonth();
      c = (c ? Ba : Ca)[e];
      if (b > c - a.getDate()) {
      ...
      if (!Fa && (Fa = !0, f.calledRun = !0, !Oa)) {
        ...
        if (lb) {
          ...
          try {
            ...
            t instanceof Ea || ("unwind" == t ? Ga = !0 : ((c = t) && "object" === typeof t && t.stack && (c = [t, t.stack]), E("exception thrown: " + c), L(1, t)));
          } finally {
          }
        }
        if (f.postRun) {
          for ("function" == typeof f.postRun && (f.postRun = [f.postRun]); f.postRun.length;) {
            nb.unshift(f.postRun.shift());
          }
        }
        ia(nb);
      }
  ...
  function mb(a, b) {
    if (!b || !Ga || 0 !== a) {
      if (!Ga && (Oa = !0, ia(Bb), d.quit(), f.onExit)) {
        f.onExit(a);
      }
      L(a, new Ea(a));
    }
  ...
  f.stdout = f.stdout || G(function(a) {
    da(a);
  });
  f.stderr = f.stderr || G(function(a) {
    E(a);
  });
  ...
  var ma = [], xa = "./this.program", va = !1, Q = !1, U = !1, qb = !1;
  ...
  var N = "", Ha, Sa;
  if (U) {
    N = Q ? require("path").dirname(N) + "/" : __dirname + "/";
    var oa = function(a, b) {
      Ha || (Ha = require("fs"));
      Sa || (Sa = require("path"));
      a = Sa.normalize(a);
    ...
    if (qb) {
      "undefined" != typeof read && (oa = function(a) {
        ...
        ta("object" === typeof a);
        return a;
      }, "undefined" != typeof scriptArgs ? ma = scriptArgs : "undefined" != typeof arguments && (ma = arguments), "function" === typeof quit && (L = function(a) {
        quit(a);
      }), "undefined" !== typeof print && ("undefined" === typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" !== typeof printErr ? printErr : print);
    } else {
      if (va || Q) {
        Q ? N = self.location.href : document.currentScript && (N = document.currentScript.src), N = 0 !== N.indexOf("blob:") ? N.substr(0, N.lastIndexOf("/") + 1) : "", oa = function(a) {
  ...
  f.thisProgram && (xa = f.thisProgram);
  f.quit && (L = f.quit);
  var ka;
  f.wasmBinary && (ka = f.wasmBinary);
  var Ga;
  f.noExitRuntime && (Ga = f.noExitRuntime);
  "object" !== typeof WebAssembly && E("no native wasm support detected");
  var pa, Db = new WebAssembly.Table({initial:2920, maximum:2920, element:"anyfunc"}), Oa = !1, Za = "undefined" !== typeof TextDecoder ? new TextDecoder("utf8") : void 0;
  "undefined" !== typeof TextDecoder && new TextDecoder("utf-16le");
  var I, V, Ta, m, Ua = f.INITIAL_MEMORY || 67108864;
  f.wasmMemory ? pa = f.wasmMemory : pa = new WebAssembly.Memory({initial:Ua / 65536, maximum:Ua / 65536});
  if (pa) {
    var Va = pa.buffer;
  }
  Ua = Va.byteLength;
  ...
  m[583544] = 7577216;
  var ob = [], kb = [], Ab = [], Bb = [], nb = [], qa = Math.abs, Z = Math.ceil, aa = Math.floor, ra = Math.min, X = 0, Na = null, ja = null;
  f.preloadedImages = {};
  f.preloadedAudios = {};
  var O = "ffmpeg-worker-mp4.wasm";
  cb(O) || (O = wb(O));
  var y, J;
  kb.push({Jb:function() {
    rb();
  ...
  var w = {jb:function(a) {
    ...
    S.mb[a] = {input:[], output:[], X:b};
    d.Na(a, S.g);
  }, g:{open:function(a) {
    var b = S.mb[a.node.rdev];
    if (!b) {
      throw new d.b(43);
    }
    a.tty = b;
    ...
    if (!a.input.length) {
      ...
      if (U) {
        ...
        try {
          e = Ha.readSync(process.stdin.fd, c, 0, 256, null);
        } catch (g) {
    ...
    null === b || 10 === b ? (da(R(a.output, 0)), a.output = []) : 0 != b && a.output.push(b);
  }, flush:function(a) {
    a.output && 0 < a.output.length && (da(R(a.output, 0)), a.output = []);
  }}, Eb:{Ja:function(a, b) {
    null === b || 10 === b ? (E(R(a.output, 0)), a.output = []) : 0 != b && a.output.push(b);
  }, flush:function(a) {
    a.output && 0 < a.output.length && (E(R(a.output, 0)), a.output = []);
  }}}, u = {J:null, l:function() {
    ...
    for (e = 0; e < a.length; e++) {
      ...
      if (!h || b.B) {
        for (h = 0; d.S(g.mode);) {
          if (g = d.readlink(c), c = P.resolve(w.dirname(c), g), g = d.h(c, {Ma:b.Ma}).node, 40 < h++) {
            throw new d.b(32);
          }
        }
      }
    ...
    return P.resolve(d.F(a.parent), a.f.readlink(a));
  }, stat:function(a, b) {
    a = d.h(a, {B:!b}).node;
    if (!a) {
      throw new d.b(44);
    ...
    d.read(e, g, 0, a, 0);
    "utf8" === b.encoding ? c = R(g, 0) : "binary" === b.encoding && (c = g);
    d.close(e);
    return c;
    ...
    S.register(d.U(5, 0), S.Fb);
    S.register(d.U(6, 0), S.Eb);
    ...
    if (oa) {
      try {
        a.c = Da(oa(a.url), !0), a.i = a.c.length;
      } catch (c) {
        b = !1;
      }
    } else {
    ...
    h.prototype.Ra = function() {
      ...
      r.ub(function(x) {
        ...
        if ("undefined" === typeof r.u[x]) {
          var Wa = r.u;
          if (D > M) {
            throw Error("invalid range (" + D + ", " + M + ") or no bytes requested!");
          }
          if (M > q - 1) {
          ...
          var B = new XMLHttpRequest;
          B.open("GET", c, !1);
          q !== k && B.setRequestHeader("Range", "bytes=" + D + "-" + M);
          ...
          D = void 0 !== B.response ? new Uint8Array(B.response || []) : Da(B.responseText || "", !0);
          Wa[x] = D;
        }
        if ("undefined" === typeof r.u[x]) {
      ...
      if (p || !q) {
        k = q = 1, k = q = this.cb(0).length, da("LazyFiles on gzip forces download of the whole file when length is accessed");
      }
      this.tb = q;
      this.sb = k;
      this.Ea = !0;
    ...
    sb.R();
    var z = b ? P.resolve(w.K(a, b)) : a, C = "cp " + z;
    bb(C);
    "string" == typeof c ? sb.fc(c, function(k) {
      q(k);
    }, l) : q(c);
  }, indexedDB:function() {
    ...
    m[c + 28 >> 2] = e.rdev;
    m[c + 32 >> 2] = 0;
    J = [e.size >>> 0, (y = e.size, 1.0 <= +qa(y) ? 0.0 < y ? (ra(+aa(y / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Z((y - +(~~y >>> 0)) / 4294967296.0) >>> 0 : 0)];
    m[c + 40 >> 2] = J[0];
    m[c + 44 >> 2] = J[1];
    m[c + 48 >> 2] = 4096;
    m[c + 52 >> 2] = e.blocks;
    ...
    m[c + 76 >> 2] = 0;
    J = [e.ino >>> 0, (y = e.ino, 1.0 <= +qa(y) ? 0.0 < y ? (ra(+aa(y / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Z((y - +(~~y >>> 0)) / 4294967296.0) >>> 0 : 0)];
    m[c + 80 >> 2] = J[0];
    m[c + 84 >> 2] = J[1];
    return 0;
    ...
    for (var g = 0, h = 0; h < c; h++) {
      var l = m[b + (8 * h + 4) >> 2], n = d.read(a, I, m[b + 8 * h >> 2], l, e);
      if (0 > n) {
        return -1;
      }
      g += n;
    ...
    for (var g = 0, h = 0; h < c; h++) {
      var l = d.write(a, I, m[b + 8 * h >> 2], m[b + (8 * h + 4) >> 2], e);
      if (0 > l) {
        return -1;
      }
      g += l;
  ...
  var fb = {}, zb = (W("GMT", V, 2334240, 4), 2334240), Ba = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Ca = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
  ...
  d.ob = ba;
  d.Yb();
  var sb, tb = {__assert_fail:function(a, b, c, e) {
    A("Assertion failed: " + ca(a) + ", at: " + [b ? ca(b) : "unknown filename", c, e ? ca(e) : "unknown function"]);
  }, __sys__newselect:function(a, b, c, e) {
    for (var g = 0, h = b ? m[b >> 2] : 0, l = b ? m[b + 4 >> 2] : 0, n = c ? m[c >> 2] : 0, t = c ? m[c + 4 >> 2] : 0, p = e ? m[e >> 2] : 0, q = e ? m[e + 4 >> 2] : 0, z = 0, C = 0, k = 0, r = 0, x = 0, D = 0, M = (b ? m[b >> 2] : 0) | (c ? m[c >> 2] : 0) | (e ? m[e >> 2] : 0), Wa = (b ? m[b + 4 >> 2] : 0) | (c ? m[c + 4 >> 2] : 0) | (e ? m[e + 4 >> 2] : 0), B = 0; B < a; B++) {
      var K = 1 << B % 32;
      if (32 > B ? M & K : Wa & K) {
        var Ia = d.M(B);
        if (!Ia) {
        ...
        var Ja = v.nb;
        Ia.g.Vb && (Ja = Ia.g.Vb(Ia));
        Ja & 1 && (32 > B ? h & K : l & K) && (32 > B ? z |= K : C |= K, g++);
        Ja & 4 && (32 > B ? n & K : t & K) && (32 > B ? k |= K : r |= K, g++);
        Ja & 2 && (32 > B ? p & K : q & K) && (32 > B ? x |= K : D |= K, g++);
      }
    }
    b && (m[b >> 2] = z, m[b + 4 >> 2] = C);
    c && (m[c >> 2] = k, m[c + 4 >> 2] = r);
    ...
    try {
      ...
      for (var g = d.v(e, 0, 1), h = Math.floor(g / 280); h < e.P.length && a + 280 <= c;) {
        ...
        J = [n >>> 0, (y = n, 1.0 <= +qa(y) ? 0.0 < y ? (ra(+aa(y / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Z((y - +(~~y >>> 0)) / 4294967296.0) >>> 0 : 0)];
        m[b + a >> 2] = J[0];
        m[b + a + 4 >> 2] = J[1];
        J = [280 * (h + 1) >>> 0, (y = 280 * (h + 1), 1.0 <= +qa(y) ? 0.0 < y ? (ra(+aa(y / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Z((y - +(~~y >>> 0)) / 4294967296.0) >>> 0 : 0)];
        m[b + a + 8 >> 2] = J[0];
        m[b + a + 12 >> 2] = J[1];
        Ta[b + a + 16 >> 1] = 280;
        I[b + a + 18 >> 0] = t;
    ...
    A();
  }, clock:wa, clock_gettime:function(a, b) {
    if (0 === a) {
      a = Date.now();
    } else {
      if (1 === a || 4 === a) {
    ...
    try {
      var c = v.G(a);
      I[b >> 0] = c.tty ? 2 : d.m(c.mode) ? 3 : d.S(c.mode) ? 7 : 4;
      return 0;
    } catch (e) {
      return "undefined" !== typeof d && e instanceof d.b || A(e), e.j;
    }
    ...
    try {
      ...
      d.v(h, a, e);
      J = [h.position >>> 0, (y = h.position, 1.0 <= +qa(y) ? 0.0 < y ? (ra(+aa(y / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Z((y - +(~~y >>> 0)) / 4294967296.0) >>> 0 : 0)];
      m[g >> 2] = J[0];
      m[g + 4 >> 2] = J[1];
    ...
    return gb(a, 2334192);
  }, gmtime_r:gb, localtime:function(a) {
    return jb(a, 2334192);
  }, localtime_r:jb, memory:pa, mktime:function(a) {
    ya();
    ...
    function t(k) {
      k = Aa(new Date(k.A + 1900, 0, 1), k.qa);
    ...
    var p = m[e + 40 >> 2];
    e = {ac:m[e >> 2], $b:m[e + 4 >> 2], oa:m[e + 8 >> 2], ia:m[e + 12 >> 2], Y:m[e + 16 >> 2], A:m[e + 20 >> 2], pa:m[e + 24 >> 2], qa:m[e + 28 >> 2], Jc:m[e + 32 >> 2], Zb:m[e + 36 >> 2], bc:p ? ca(p) : ""};
    c = ca(c);
    ...
    p = {"%a":function(k) {
      ...
      return h(k.ia + Qa(za(k.A + 1900) ? Ba : Ca, k.Y - 1), 3);
    }, "%m":function(k) {
      return h(k.Y + 1, 2);
    }, "%M":function(k) {
      return h(k.$b, 2);
      ...
      var r = new Date(k.A + 1900, 0, 1), x = 0 === r.getDay() ? r : Aa(r, 7 - r.getDay());
      k = new Date(k.A + 1900, k.Y, k.ia);
      return 0 > l(x, k) ? (r = Qa(za(k.getFullYear()) ? Ba : Ca, k.getMonth() - 1) - 31, h(Math.ceil((31 - x.getDate() + r + k.getDate()) / 7), 2)) : 0 === l(x, r) ? "01" : "00";
    }, "%V":function(k) {
      var r = new Date(k.A + 1901, 0, 4), x = n(new Date(k.A + 1900, 0, 4));
      r = n(r);
      var D = Aa(new Date(k.A + 1900, 0, 1), k.qa);
      return 0 > l(D, x) ? "53" : 0 >= l(r, D) ? "01" : h(Math.ceil((x.getFullYear() < k.A + 1900 ? k.qa + 32 - x.getDate() : k.qa + 1 - x.getDate()) / 7), 2);
    }, "%w":function(k) {
      return k.pa;
    }, "%W":function(k) {
      var r = new Date(k.A, 0, 1), x = 1 === r.getDay() ? r : Aa(r, 0 === r.getDay() ? 1 : 7 - r.getDay() + 1);
      k = new Date(k.A + 1900, k.Y, k.ia);
      return 0 > l(x, k) ? (r = Qa(za(k.getFullYear()) ? Ba : Ca, k.getMonth() - 1) - 31, h(Math.ceil((31 - x.getDate() + r + k.getDate()) / 7), 2)) : 0 === l(x, r) ? "01" : "00";
    }, "%y":function(k) {
    ...
    var e = {env:tb, wasi_snapshot_preview1:tb};
    bb("wasm-instantiate");
    ...
    (function() {
      if (ka || "function" !== typeof WebAssembly.instantiateStreaming || cb(O) || Pa(O, "file://") || "function" !== typeof fetch) {
        return c(b);
      }
      fetch(O, {credentials:"same-origin"}).then(function(g) {
  ...
  var rb = f.___wasm_call_ctors = function() {
    return (rb = f.___wasm_call_ctors = f.asm.__wasm_call_ctors).apply(null, arguments);
  }, eb = f.___errno_location = function() {
    return (eb = f.___errno_location = f.asm.__errno_location).apply(null, arguments);
  };
  f._fflush = function() {
  ...
  var Ka = f._malloc = function() {
    return (Ka = f._malloc = f.asm.malloc).apply(null, arguments);
  }, ea = f.__get_tzname = function() {
    return (ea = f.__get_tzname = f.asm._get_tzname).apply(null, arguments);
  }, ib = f.__get_daylight = function() {
    return (ib = f.__get_daylight = f.asm._get_daylight).apply(null, arguments);
  }, hb = f.__get_timezone = function() {
    return (hb = f.__get_timezone = f.asm._get_timezone).apply(null, arguments);
  };
  f.stackSave = function() {
    return (f.stackSave = f.asm.stackSave).apply(null, arguments);
  };
  var La = f.stackAlloc = function() {
    return (La = f.stackAlloc = f.asm.stackAlloc).apply(null, arguments);
  };
...
self.onmessage = function(H) {
  ...
  if ("run" == ba.type) {
    if (vb) {
      ...
      var L = {};
      Object.keys(ba).forEach(function(G) {
        "type" !== G && (L[G] = ba[G]);
      });
      L.print = function(G) {
        self.postMessage({type:"stdout", data:G});
      };
      L.printErr = function(G) {
        self.postMessage({type:"stderr", data:G});
      };
      L.onExit = function(G) {
        self.postMessage({type:"exit", data:G});
      };
      L.onAbort = function(G) {
        self.postMessage({type:"abort", data:G});
      };
      H = Ya(L);
      var sa = H.MEMFS.map(function(G) {
        return G.data.buffer;
      });
      self.postMessage({type:"done", data:H}, sa);
      vb = !1;
    }
  } else {
